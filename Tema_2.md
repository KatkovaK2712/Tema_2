...
## Выводы
1. При сложении/вычитании двух переменных типа int конечный результат будет тоже иметь тип int.
2. При сложении/вычитании двух переменных типа float конечный результат будет тоже иметь тип float.
3. При сложении/вычитании двух переменных типа int и float конечный результат будет иметь тип float.
